...
const pluginDir = path.resolve("C:/Users/chris/Documents/e-Sword/dragncards/bttactics2-dragncards-plugin");
...
const tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "bttactics2-gamedef-"));
