#!/usr/bin/env python3
"""Validate the generated Middle Earth CCG DragnCards plugin."""
...
def main() -> int:
    ...
    if game_def.get("pluginName") != "Middle Earth CCG":
        errors.append(f"pluginName should be 'Middle Earth CCG', got {game_def.get('pluginName')!r}")
