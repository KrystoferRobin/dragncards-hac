...
const pluginDir = path.resolve("C:/Users/chris/Documents/e-Sword/dragncards/middle-earth-ccg-dragncards-plugin");
...
const tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "meccg-gamedef-"));
