...
const pluginDir = path.resolve("C:/Users/chris/Documents/e-Sword/dragncards/7th-sea-dragncards-plugin");
...
const tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "7thsea-gamedef-"));
