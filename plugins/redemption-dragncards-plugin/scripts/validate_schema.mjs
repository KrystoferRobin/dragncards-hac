...
const pluginDir = path.resolve("C:/Users/chris/Documents/e-Sword/dragncards/redemption-dragncards-plugin");
...
const tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "redemption-gamedef-"));
