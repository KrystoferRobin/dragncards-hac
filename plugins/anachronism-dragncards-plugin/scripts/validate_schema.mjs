...
const pluginDir = path.resolve("C:/Users/chris/Documents/e-Sword/dragncards/anachronism-dragncards-plugin");
...
const tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "anachronism-gamedef-"));
