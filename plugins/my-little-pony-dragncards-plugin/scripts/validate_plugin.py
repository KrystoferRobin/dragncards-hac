#!/usr/bin/env python3
"""Validate the generated My Little Pony DragnCards plugin."""
...
PLUGIN_DIR = Path(r"C:\Users\chris\Documents\e-Sword\dragncards\my-little-pony-dragncards-plugin")
...
def main() -> int:
    ...
    if game_def.get("pluginName") != "My Little Pony":
        errors.append(f"pluginName {game_def.get('pluginName')!r} is not 'My Little Pony'")
