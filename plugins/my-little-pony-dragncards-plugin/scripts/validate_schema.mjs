...
const pluginDir = path.resolve("C:/Users/chris/Documents/e-Sword/dragncards/my-little-pony-dragncards-plugin");
...
const tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "mlp-gamedef-"));
