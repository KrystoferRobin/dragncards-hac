...
const pluginDir = path.resolve("C:/Users/chris/Documents/e-Sword/dragncards/wyvern-dragncards-plugin");
...
const tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "wyvern-gamedef-"));
