import { formatGroupId } from '../../engine/functions/formatGroupId';
...
export function adaptRegions(layoutRegions, observingPlayerN, numPlayers, groupById = {}, gameDef = null, language = 'English', seatedPlayerN = null) {
